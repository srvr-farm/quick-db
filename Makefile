...
venv/bin/activate: setup.py
	...
	. venv/bin/activate ; pip install -i ${PKG} -U pip
	. venv/bin/activate ; pip install -i ${PKG} -U setuptools
	. venv/bin/activate ; pip install -i ${PKG} -U .
develop: venv
	. venv/bin/activate ; unset https_proxy; pip install -i ${PKG} -e .
clean:
